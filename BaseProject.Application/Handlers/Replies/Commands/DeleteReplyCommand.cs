...
public class DeleteReplyCommand : IRequest<Result>
{
    public Guid Id { get; set; }
    
    public byte[] RowVersion { get; set; }
    
    public class DeleteReplyCommandHandler : IRequestHandler<DeleteReplyCommand, Result>
    {
        private readonly ICurrentUser _currentUser;
        private readonly IEntityGeneralRepository _repository;
        private readonly IMapper _mapper;

        public DeleteReplyCommandHandler(ICurrentUser currentUser, IEntityGeneralRepository repository, IMapper mapper)
        {
        ...
        public async Task<Result> Handle(DeleteReplyCommand request, CancellationToken cancellationToken)
        {
            ...
            reply.DeleterUserId = _currentUser.GetUserId();
            reply.DeletionTime = DateTime.UtcNow;
